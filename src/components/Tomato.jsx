...
const topTomatoVariants = {
  hover: { opacity: 0.1, scale: 1, x: 0, y: 0, rotate: 0 },
  tap: { opacity: 0.1, scale: 0.9, x: -15, y: -15, rotate: -5 },
...
const Tomato = ({
  ...
  return (
    <motion.svg viewBox="0 0 318.34 318.34" style={{ width: "80%" }}>
      <defs>
        <radialGradient
          id="radial-gradient"
          cx={159.17}
      ...
      <g id="Layer_2" data-name="Layer 2">
        ...
        {/* Quarter 1 */}
        <AnimatePresence>
          {(currentPomodoro === 1 && showCurrentExo) && (
            <motion.g
        ...
        <motion.g
          ...
          animate={
            (currentPomodoro === 2 && showCurrentExo) || currentPomodoro < 2
              ? "show"
              : "hide"
          }
          whileHover="hover"
        ...
        <motion.g
          ...
          initial={{ opacity: 1, scale: 1 }}
          animate={
            (currentPomodoro === 3 && showCurrentExo) || currentPomodoro < 3
              ? "show"
              : "hide"
          }
          whileHover="hover"
        ...
        <motion.g
          ...
          initial={{ opacity: 1, scale: 1 }}
          animate={
            (currentPomodoro === 4 && showCurrentExo) || currentPomodoro < 4
              ? "show"
              : "hide"
          }
          whileHover="hover"
